...
std::string do_slugify(char* s){
  ...
  UnicodeString str = const_cast<char*>(s2.c_str());
  UErrorCode status = U_ZERO_ERROR;
  Transliterator *any_latin = Transliterator::createInstance("Any-Latin", UTRANS_FORWARD, status);
  any_latin->transliterate(str);
